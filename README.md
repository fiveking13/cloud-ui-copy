...
```shell
➜  git remote -v
origin  git@github.com:unitestream/cloud-ui.git (fetch)
origin  git@github.com:unitestream/cloud-ui.git (push)
up      git@github.com:marmelab/react-admin.git (fetch)
up      git@github.com:marmelab/react-admin.git (push)
